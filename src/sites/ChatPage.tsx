                    ...
                    {messages.map((msg) => (
                        ...
                        >
                            ...
                            {msg.user === "Bot" && !isBotResponding && msg.text.trim().length > 0 && (
                                <div className="flex space-x-2 mt-2 justify-start"> {/* Anpassung der Ausrichtung */}
                                    {msg.evaluation === "null" && (
                                        <>
                                            {/* Daumen Hoch Button */}
                                            <button
                                            ...
                                            >
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon-sm-heavy">
